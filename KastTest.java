...
class KastTest {
    ...
    //ennem täitmist ja pärast täitmist
    @Test
    void leiaYhineMass() {
        ...
        assertEquals(6.325, kast1.leiaYhineMass(), 0.001);
        vaat1.t2idaPudelid(pudelid);
        assertEquals(12.045, kast1.t2idaTyhjadPudelid(vaat1), 0.001);
    }

    @Test
    void leiaOmahindKokku() {
        ArrayList<Joogipudel> pudelid = new ArrayList<>();
        Jook siirup = new Jook("Siirup", 0.63, 1.12);
        Jook limonaad = new Jook("limonaad", 0.75, 0.88);
        Jook vesi = new Jook("vesi", 0.17, 0.75);
        ...
        pudelid.add(pudel4);
        Kast kast1 = new Kast("Plastik kast", 0.5, 0.2, 20, pudelid);
        assertEquals(3.208, kast1.leiaOmahindKokku(), 0.001);
    }
